%% Automated Dir Search Dependency Search Script
...
% R.matlab packages. 
%
% Please note that this script cannot be run by itself, it must be called
% from the authodirsearchmatrixprocessor.m script in order to function. If
% you require the same functionality, run the automatedmatrixprocessor.m
% script from the R script.
%
% 
